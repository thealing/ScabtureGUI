...
public:
	...
	static void convertBgrToNv12(const uint32_t* bgr, uint8_t* y, uint8_t* uv, size_t width, size_t height);

	static void convertBgrToIyuv(const uint32_t* bgr, uint8_t* y, uint8_t* u, uint8_t* v, size_t width, size_t height);
