...
int real_main() {
	...
	RegisterClass(&wc);
	CreateWindow(wc.lpszClassName, L"CaptureBit v1.2", WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, NULL, NULL);
	init_settings();
	init_config();
