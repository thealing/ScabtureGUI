...
int real_main() {
	...
	wc.lpszClassName = L"CaptureBit Window Class";
	wc.style = CS_OWNDC | CS_HREDRAW | CS_VREDRAW;
	RegisterClass(&wc);
	CreateWindow(wc.lpszClassName, L"CaptureBit v1.1", WS_OVERLAPPEDWINDOW | WS_CLIPCHILDREN | WS_VISIBLE, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, NULL, NULL);
	init_settings();
	init_config();
